...
enum {
  ...
  field_path = 4,
  field_request_type = 5,
  field_response_type = 6,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 14, .production_id = 8),
  [406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 13, .production_id = 7),
  [408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_message_or_enum_type, 3),
  [410] = {.entry = {.count = 1, .reusable = true}}, SHIFT(272),
  [412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 13, .production_id = 6),
  [414] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 13, .production_id = 8),
  [416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 12, .production_id = 5),
  [418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 12, .production_id = 7),
  [420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 12, .production_id = 6),
  [422] = {.entry = {.count = 1, .reusable = true}}, SHIFT(137),
  [424] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 12, .production_id = 8),
  [426] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 11, .production_id = 5),
  [428] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 11, .production_id = 7),
  [430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 11, .production_id = 6),
  ...
  [441] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rpc, 10, .production_id = 5),
